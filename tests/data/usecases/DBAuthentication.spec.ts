import { mockAuthenticationParams, throwError } from '@tests/domain/fakes'
import { EncrypterSpy, HashComparerSpy, LoadAccountByEmailRepositorySpy, UpdateAccessTokenRepositorySpy } from '@tests/data/fakes'
