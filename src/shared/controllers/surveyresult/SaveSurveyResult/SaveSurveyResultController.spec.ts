import { HttpRequest, LoadSurveyById, SaveSurveyResult } from './SaveSurveyResultControllerProtocols'
...
import { mockLoadSurveyById, mockSaveSurveyResult } from '@shared/test'
